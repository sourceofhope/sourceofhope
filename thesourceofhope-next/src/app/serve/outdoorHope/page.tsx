    ...
    <section className="w-full md:justify-items-left items-center grid gap-5 pt-25 p-5 lg:px-35 text-sm md:text-md lg:text-lg">
      ...
      <article className="grid gap-5">
        <p>
          ...
          never have had the opportunity to explore nature. Our initiative aims
          to bridge that gap by offering{" "}
          <Bold>
        ...
        <p>
          ...
          program provides valuable education on camping, fishing, hunting, and
          outdoor survival skills. Whether you&apos;re a beginner or an outdoor
      ...
      <article className="grid gap-5">
        ...
        <div className="grid grid-flow-row md:grid-cols-[6fr_3fr] gap-5 items-center">
          <div className="flex flex-col gap-5 col-start-auto md:col-start-1">
            <p>
              Wesley will guide the community through proper hunting practices,
              including bow and arrow education, hunting calendars, and gun
              safety classes. We place a strong emphasis on responsible hunting,
              as it is crucial for us to respect and
              <HighlightedText>
            ...
            <Blockquote className="border-accent-600">
              Interested in safe gun handling or who would like to improve their
              skills? Check out{" "}
              <ExpressiveAnchor
                inText
