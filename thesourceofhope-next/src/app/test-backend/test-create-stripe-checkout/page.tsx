...
export default function TestCreateStripeCheckoutPage() {
	const [endpoint, setEndpoint] = useState('/api/checkout/create-stripe-checkout');
	...
	return (
		<main style={{ maxWidth: 960, margin: '0 auto', padding: 24 }}>
			<h1 style={{ fontSize: 28, marginBottom: 8 }}>Test Create Stripe Checkout</h1>
			<p style={{ marginBottom: 18 }}>
				Send mock checkout data to your Stripe checkout API route and inspect the response.
			</p>
