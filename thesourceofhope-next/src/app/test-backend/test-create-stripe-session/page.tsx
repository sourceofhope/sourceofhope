...
const mockPayload = {
	...
	taxAmount: 3.42,
	processingFee: 1.5,
	return_url: 'http://localhost:3000/checkout/stripe-return',
};

export default function TestCreateStripeSessionPage() {
	const [endpoint, setEndpoint] = useState('/api/checkout/create-stripe-session');
	...
	return (
		<main style={{ maxWidth: 960, margin: '0 auto', padding: 24 }}>
			<h1 style={{ fontSize: 28, marginBottom: 8 }}>Test Create Stripe Session</h1>
			<p style={{ marginBottom: 18 }}>
				Send mock checkout data to your Stripe session API route and inspect the response.
			</p>
