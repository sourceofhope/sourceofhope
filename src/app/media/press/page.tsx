...
export const metadata: Metadata = {
  title: "Press & Media | The Source of Hope",
  description:
    "Explore The Source of Hope Press & Media hub featuring television coverage, podcasts, radio interviews, videos, and stories highlighting our nonprofit’s mission and community impact across Dallas–Fort Worth and beyond.",
  openGraph: {
    type: "website",
    title: "Press & Media | The Source of Hope",
    description:
      "Watch and listen to television features, interviews, podcasts, and press coverage showcasing the heart, mission, and community impact of The Source of Hope.",
  },
  twitter: {
    card: "summary_large_image",
    title: "Press & Media | The Source of Hope",
    description:
      "Discover television segments, interviews, podcasts, and press stories sharing hope, healing, and community transformation through The Source of Hope.",
  },
};
...
function MediaCard({ title, mediaID, reverse = false, children }: MediaCardProps) {
  return (
    <div
      className={`
