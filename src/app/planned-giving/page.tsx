      ...
      <section className="bg-white px-7 md:px-0 py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-7">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-14 md:gap-14 items-center">
            <div>
              <p className="text-xs font-bold tracking-widest text-blue-600 uppercase mb-4">Planned Giving</p>
              <h1 className="text-5xl md:text-7xl font-bold text-blue-900 leading-tight mb-6">
                Your Legacy.<br /><span className="text-blue-500">Their Hope.</span>
              </h1>
        ...
        <div className="max-w-5xl mx-auto px-7">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="flex flex-col items-center text-center p-6">
              <svg className="w-8 h-8 text-blue-500 mb-3 stroke-current flex-shrink-0" viewBox="0 0 24 24" fill="none" strokeWidth="1.5">
                <path d="M12 20s-7-4.4-7-9.5A3.5 3.5 0 0 1 12 8a3.5 3.5 0 0 1 7 2.5C19 15.6 12 20 12 20Z"/>
              </svg>
              <p className="text-sm text-gray-700 leading-relaxed">Planned giving isn't only for wealthy individuals. Any gift, of any size, can create lasting hope.</p>
            </div>
            <div className="flex flex-col items-center text-center p-6">
              <svg className="w-8 h-8 text-blue-500 mb-3 stroke-current flex-shrink-0" viewBox="0 0 24 24" fill="none" strokeWidth="1.5">
                <path d="M12 21c-5-2.5-7-6-7-10V6l7-3 7 3v5c0 4-2 7.5-7 10Z"/>
              </svg>
              <p className="text-sm text-gray-700 leading-relaxed">You can support your family and still leave a legacy that makes a difference.</p>
            </div>
            <div className="flex flex-col items-center text-center p-6">
              <svg className="w-8 h-8 text-blue-500 mb-3 stroke-current flex-shrink-0" viewBox="0 0 24 24" fill="none" strokeWidth="1.5">
              ...
              <p className="text-sm text-gray-700 leading-relaxed">Many supporters continue giving during their lifetime while also including a future gift.</p>
            </div>
            <div className="flex flex-col items-center text-center p-6">
              <svg className="w-8 h-8 text-blue-500 mb-3 stroke-current flex-shrink-0" viewBox="0 0 24 24" fill="none" strokeWidth="1.5">
              ...
              <p className="text-sm text-gray-700 leading-relaxed">Already included The Source of Hope in your plans? We'd love to hear from you.</p>
            </div>
          </div>
        </div>
      </section>
