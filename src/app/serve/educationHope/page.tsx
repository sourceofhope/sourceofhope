...
import { AcademicCapIcon, CalculatorIcon, LanguageIcon } from "@heroicons/react/20/solid";
...
export const metadata: Metadata = {
  ...
  description: "Explore The Source of Hope's Education for Hope Program, providing virtual tutoring, reading and writing mentorship, and academic support through the TSOH ILA Tutoring Program. Empowering students to excel in literacy, test preparation, and long-term academic success.",
  alternates: {
  ...
  openGraph: {
    ...
    url: CANONICAL_URL,
    title: "Education for Hope Program | The Source of Hope",
    description: "Join the Education for Hope Program to receive free virtual tutoring and academic mentorship. Students gain support in reading, writing, standardized test prep, and literacy development through the TSOH ILA Tutoring Program.",
  },
  twitter: {
    card: "summary_large_image",
    title: "Education for Hope Program | The Source of Hope",
    description: "Access free academic support through The Source of Hope's Education for Hope Program—offering virtual tutoring, reading and writing mentorship, and test preparation to help students thrive.",
  },
};
  ...
  return (
    <section className="w-full md:justify-items-left items-center grid gap-5 pt-25 p-5 lg:px-35 text-sm md:text-md lg:text-lg">
      ...
      <article className="grid gap-3">
        <p>
          <Bold>The Education For Hope</Bold> program offers tutoring services, supports cosmetology students, and provides opportunities through the{' '}
          <HighlightedText>Federal Work-Study program</HighlightedText> in partnership with <Bold>The University of Texas at Dallas</Bold>. We assist students of all ages by offering scholarships to low-income cosmetology students, facilitating advanced beauty education, and hiring for operations roles through Work-Study.
        </p>
      ...
      <article>
        ...
        <div className="grid gap-5 py-5">
          <ExpressiveCard className="grid gap-3" title="EMERGING PROFESSIONALS PROGRAM">
            <p>
            ...
            <h4 className="font-semibold">Federal Work-Study and Emerging Professional Program (EPP) Opportunities</h4>
            <p>
          ...
          <ExpressiveCard className="grid gap-3" title="Beauty of Education Scholarship Program">
            <p>
          ...
          <ExpressiveCard className="grid gap-3" title="Hope Scholarship Program">
            <p>
      ...
      <article className="grid gap-5">
        ...
        <div className="grid grid-flow-row md:grid-cols-[6fr_3fr] gap-5 items-center">
          <div className="grid gap-5 grid-flow-row justify-start">
            <p>
              The Source of Hope offers <Bold>virtual tutoring</Bold> for middle school and high school students—empowering learners to grow from anywhere.
            </p>
            <article className="bg-neutral-50 rounded-2xl shadow-sm p-5 grid gap-2 w-full">
              <Heading className="border-b-2 border-neutral-300 pb-2">Tutoring Services</Heading>
            ...
            <p>
              All tutoring sessions are held <Bold>virtually</Bold>, allowing students to participate from any location with flexible scheduling options.
            </p>
            <p className="pl-5 py-0 border-l-4 border-accent-600">
              <Bold>The Source of Hope</Bold> is currently hiring ILA (Integrated Language Arts) tutors. Both students and adults can apply. Tutors receive <Bold>50%</Bold> of session earnings, while the remaining proceeds support our community programs.
            </p>
            <p>
              If you specialize in a subject not listed above,{' '}
              <HighlightedText>we still encourage you to apply!</HighlightedText>{' '}
          ...
          <div className="space-y-3 justify-self-end w-full">
            <div className="rounded-2xl object-cover w-full aspect-square overflow-hidden">
              <Carousel hideControls auto>
                <CarouselCard src={`/${ASSET_VERSION}/educationHope/Carousel-1.webp`} />
                <CarouselCard src={`/${ASSET_VERSION}/educationHope/Carousel-2.webp`} />
                <CarouselCard src={`/${ASSET_VERSION}/educationHope/Carousel-3.webp`} />
                <CarouselCard src={`/${ASSET_VERSION}/educationHope/Carousel-4.webp`} />
                <CarouselCard src={`/${ASSET_VERSION}/educationHope/Carousel-5.webp`} />
                <CarouselCard src={`/${ASSET_VERSION}/educationHope/Carousel-6.webp`} />
                <CarouselCard src={`/${ASSET_VERSION}/educationHope/Carousel-7.webp`} />
                <CarouselCard src={`/${ASSET_VERSION}/educationHope/Carousel-8.webp`} />
                <CarouselCard src={`/${ASSET_VERSION}/educationHope/Carousel-9.webp`} />
                <CarouselCard src={`/${ASSET_VERSION}/educationHope/Carousel-10.webp`} />
              </Carousel>
            </div>
            <AnchorButton
              className="w-full"
      ...
      <article className="grid gap-5">
        <Title>Mentors</Title>
        <p>
          <Bold>The Source of Hope</Bold> offers mentorship opportunities through its <Bold>TSOH ILA Tutoring Program</Bold>. This initiative aims to{' '}
          <HighlightedText>empower students academically</HighlightedText> by providing individualized virtual mentorship in reading and writing.
        </p>
        <p>
          Tutors can assist students in preparing for standardized tests like the <Bold>STAAR</Bold>, <Bold>SAT</Bold>, and <Bold>ACT</Bold>, analyzing literature, and developing writing skills. Prospective tutors should have reliable internet access, experience with virtual meeting platforms (e.g., Zoom, Google Meet), and be comfortable with English.
        </p>
      </article>
    </section>
  );
