...
export const metadata: Metadata = {
  ...
  description:
    "Discover The Source of Hope's Wellness of Hope Program, providing free or reduced-cost holistic treatments—fire cupping, lymphatic drainage, detox therapies, and more—to low-income individuals, seniors, teachers, first responders, and families across Dallas–Fort Worth.",
  alternates: {
  ...
  openGraph: {
    ...
    title: "Wellness of Hope Program | The Source of Hope",
    description:
      "Experience compassionate holistic care through the Wellness of Hope Program. We provide reduced-cost wellness treatments—including fire cupping, lymphatic drainage, ear candling, and detox therapies—to seniors, teachers, first responders, and families in need.",
  },
  twitter: {
    card: "summary_large_image",
    title: "Wellness of Hope Program | The Source of Hope",
    description:
      "Join the Wellness of Hope Program, offering holistic wellness treatments and assessments at reduced cost for low-income individuals, seniors, educators, first responders, and families throughout Dallas–Fort Worth.",
  },
};
          ...
          <div className="grid grid-cols-1 md:grid-cols-[6fr_3fr] gap-5 items-center">
            <div className="flex flex-col gap-5">
              ...
              <p>
                ...
                our shared commitment to supporting the community&apos;s
                complete well-being.
              </p>
            </div>
