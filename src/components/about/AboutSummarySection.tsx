  ...
  return (
    <PageSection className="grid gap-5 pb-5 text-sm md:text-md lg:text-lg">
      ...
      <div className="text-sm md:text-md lg:text-lg grid gap-5 text-neutral-600">
        <p>
          <Bold>
            At The Source of Hope, we meet people where they are—and we
            don&rsquo;t give up on them.
          </Bold>{" "}
          Our work is built on compassion, trust, and showing up consistently
          for our community. We don&rsquo;t just provide services; we walk
          alongside individuals and families with dignity, care, and the belief
          that healing and renewal are possible. Whether someone is facing
          hunger, housing instability, or simply feeling forgotten, we are here.
        </p>
