...
export default function ExpressiveCard({
  ...
  return (
    <div
      ...
      } hover:bg-neutral-200 flex flex-col rounded-2xl drop-shadow-sm overflow-hidden h-fit p-5 text-neutral-950 transition-colors duration-750 cursor-pointer`}>
