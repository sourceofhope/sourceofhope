...
export default function AboutPage() {
  return (
    <>
      <PageSection className="md:justify-items-center items-start pt-30 mt-0 gap-5">
        <h2 className="text-xlg md:text-xxlg">
          We're a{" "}
      ...
      <PageSection className="grid-flow-row md:grid-flow-col md:grid-cols-[60%_40%] gap-5 md:gap-0">
        <article className="flex gap-5 flex-col">
          ...
          <div className="flex flex-col text-sm md:text-md">
            ...
            <p className="w-fit font-light px-2 text-neutral-600">
        ...
        <article>
          <img
            className="block w-full aspect-square bg-accent-900 rounded-2xl object-cover object-center"
          />
        </article>
      </PageSection>
    </>
