...
export default function TeamMemberBioPage() {
  ...
  const { name, title, bio } = member.acf || {};
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`${CANONICAL_URL.about}/team/${memberSlug}`} />
      </Helmet>
      ...
      <PageSection className="pt-10 pb-20">
        <div className="max-w-7xl mx-auto">
          <div className="relative">
            ...
            <div className="mb-6">
              <h1 className="text-3xl font-bold text-blue-600 uppercase mb-2">
                {name}
              </h1>
              {title && (
            ...
            {bio && (
              <div className="prose prose-lg prose-neutral max-w-none">
                <p className="text-neutral-700 leading-relaxed text-justify" style={{ textAlign: 'justify' }}>
                  {bio}
                </p>
              </div>
            )}
