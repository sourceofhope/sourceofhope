  ...
  return (
    <section
      ...
      <img
        ...
        [mask-image:linear-gradient(to_bottom,white_65%,transparent_100%)] [webkit-mask-image:linear-gradient(to_bottom,white_65%,transparent_100%)]
      ...
      />
      <div
        className={`absolute z-10 w-fit self-end top-[59%] md:top-[52%] grid px-5 lg:px-35 items-start ${className}`}>
        {children}
      </div>
    </section>
  );
