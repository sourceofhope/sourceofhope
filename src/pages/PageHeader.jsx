  ...
  return (
    <section
      ...
      <img
        ...
        style={{
          WebkitMaskImage:
            "linear-gradient(to bottom, white 65%, transparent 100%)",
          maskImage: "linear-gradient(to bottom, white 65%, transparent 100%)",
        }}
        src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/PNG_Test.png/960px-PNG_Test.png?20250623065344"
      />
      <div
        className={`absolute z-10 w-fit self-end top-[59%] grid px-5 lg:px-35 items-start ${className}`}>
        {children}
      </div>
    </section>
  );
