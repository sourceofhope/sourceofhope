      ...
      <section className="relative w-full pt-5 grid gap-5 bg-neutral-200">
        ...
        <ServingArticle
          ...
          <p className="text-balance text-sm md:text-md">
            ...
            one-on-one to inspire confidence, critical thinking, and a lifelong
            love of learning. By helping students reach academic goals, we build
            stronger foundations for brighter futures.
          </p>
          <button className="w-fit font-semibold">
            <ExpressiveLink
              className="text-sm text-accent-500"
        ...
        <ServingArticle
          ...
          <p className="text-balance text-sm md:text-md">
            ...
            resources to other nonprofits, shelters, and community organizations
            across North Texas. By partnering with local missions and outreach
            centers, we multiply our impact—ensuring every donated meal reaches
        ...
        <ServingArticle
          ...
          <p className="text-balance text-sm md:text-md">
            ...
            international partnerships providing food, educational supplies, and
            wellness aid to communities in Southeast Asia and beyond. By
